      ...
      <div className="width-100% height-100% py-8 space-y-16">
        ...
        <div className="w-full max-w-[1750px] mx-auto pl-[35px]">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 relative">
            <div className="space-y-6 text-center bg-[#FF8301] rounded-xl shadow-lg w-[40%] absolute top-0 right-0 z-10" style={{ margin: '35px', marginLeft: '0px', right: '0px', height: '100%'}}>
              <h2 className="text-3xl font-bold text-black text-center px-20 pt-5">About CoCo</h2>
              <div className="flex flex-col justify-between space-y-4 text-gray-800 px-20 pb-8 max-h-full text-right overflow-hidden">
                <p>
                  CoCo Bubble Tea, founded in 1997 by Chairman Tommy Hung, is a global leader in bubble tea, known for its commitment to 
                  quality and innovation. With a mission of "Consistency and Continuity," CoCo has become a favorite among bubble tea lovers 
                  worldwide.
                </p>
                <p>
                  In Canada, CoCo Bubble Tea offers a diverse menu of creative drinks made with fresh ingredients, served in stylish and welcoming 
                  stores. From classic milk teas to bold fruit infusions, CoCo brings an authentic and innovative bubble tea experience to communities 
                  across the country.
                </p>
                <p>
                  As CoCo expands in Canada, it remains dedicated to inclusivity, sustainability, and a passion for tea. Discover your nearest CoCo location 
                  and join the bubble tea revolution today!
                </p>
              </div>
            </div>
            <div className="w-full md:w-[65%] h-full rounded-xl shadow-lg" style={{ margin: '35px', marginLeft: '0px' }}>
              <img 
                src="/images/CoCo Macleod Front Store.jpg"
                alt="CoCo Store"
