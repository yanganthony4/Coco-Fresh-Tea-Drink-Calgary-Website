...
export default function ContactForm() {
  ...
  useEffect(() => {
    if (!emailUserID) {
      console.warn("⚠️ Missing NEXT_PUBLIC_EMAILJS_USER_ID in environment variables.");
    }
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      await emailjs.send(emailServiceID, emailTemplateID, sanitizedData, emailUserID);
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
            ...
            {recaptchaSiteKey ? (
              ...
              <div className="text-red-600 font-semibold">
                ⚠️ reCAPTCHA is not configured. Please check your environment variables.
              </div>
            )}
